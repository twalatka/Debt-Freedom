...
export let loan1 = new loan(4195, 1001,'Student Loan', 44000, .08, 400.00, '4/15/17', 'monRem');
export let loan2 = new loan(4196, 1002, "Jeep", 11500, .05, 500.00, '4/01/17', 'monRem');

//create payment instances
// constructor(pmt#, loanNum, id, date, totMnthlyPmt, intPaid, prinPd, remBal)
export let pmt1 = new payment(4195, 101, 1001, '5/01/17', 2000.00, 1.0066, 290.40, 1709.6, 42290.40);
export let pmt2 = new payment(4195, 102, 1001, '6/01/17', 2000.00, 1.0066, 279.12, 1720.99, 40569.52);
export let pmt3 = new payment(4195, 103, 1001, '7/01/17', 2000.00, 1.0066, 267.76, 172.24, 38837.28);
export let pmt4 = new payment(4196, 104, 1002, '5/15/17', 500.00, 1.0042, 48.30, 451.70, 11048.30);
export let pmt5 = new payment(4196, 105, 1002, '6/15817', 500.00, 1.0042, 46.40, 453.60, 10594.70);
export let pmt6 = new payment(4196, 105, 1002, '7/15/17', 500.00, 1.0042, 44.50, 455.50, 10139.2);
