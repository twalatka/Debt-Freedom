...
// constructor(id, pmt#, loanNum, date, totMnthlyPmt, intRate, intPaid, prinPd, remBal)
export let pmt1 = new payment(uuidV4(), 1001, 101, '5/01/17', 2000.00, 1.0066, 290.40, 1709.6, 42290.40);
export let pmt2 = new payment(uuidV4(), 1001, 102, '6/01/17', 2000.00, 1.0066, 279.12, 1720.99, 40569.52);
export let pmt3 = new payment(uuidV4(), 1001, 103, '7/01/17', 2000.00, 1.0066, 267.76, 172.24, 38837.28);
export let pmt4 = new payment(uuidV4(), 1002, 104, '5/15/17', 500.00, 1.0042, 48.30, 451.70, 11048.30);
export let pmt5 = new payment(uuidV4(), 1002, 105, '6/15817', 500.00, 1.0042, 46.40, 453.60, 10594.70);
export let pmt6 = new payment(uuidV4(), 1002, 106, '7/15/17', 500.00, 1.0042, 44.50, 455.50, 10139.2);
